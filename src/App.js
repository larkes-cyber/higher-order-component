...
const withSlider = (WrapComponent, someFetch) => {
    return (props) => {
...
const FirstComponent = withSlider(SliderFirst, getDataFromFirstFetch);
const SecondComponent = withSlider(SliderSecond, getDataFromSecondFetch); 
